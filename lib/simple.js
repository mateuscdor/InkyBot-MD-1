...
const sms = (conn, m) => {
	...
	if (m.message) {
		...
		if (m.msg) {
			...
			if (m.quoted) {
				...
				m.quoted.mentionUser = m.msg.contextInfo != null ? m.msg.contextInfo.mentionedJid : []
	...
	m.reply = (teks = '', option = {id: m.chat, mentions: [m.sender], quoted: m }) => conn.sendMessage(option.id ? option.id : m.chat, { text: teks, contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : ((option.quoted == null) ? null : m) })
	m.replyS = (stik, option = { id: m.chat, mentions: [m.sender], quoted: m }) => conn.sendMessage(option.id ? option.id : m.chat, { sticker: stik, contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : ((option.quoted == null) ? null : m) })
	m.replyImg = (img, teks, option = { id: m.chat, mentions: [m.sender], quoted: m }) => conn.sendMessage(option.id ? option.id : m.chat, { image: img, mimetype: 'image/jpeg', caption: teks, contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : ((option.quoted == null) ? null : m) })
	m.replyVid = (vid, teks, option = { id: m.chat, mentions: [m.sender], gif: false, quoted: m }) => conn.sendMessage(option.id ? option.id : m.chat, { video: vid, mimetype: 'video/mp4', caption: teks, gifPlayback: option.gif ? option.gif : false, contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : ((option.quoted == null) ? null : m) })
	m.replyAud = (aud, option = { id: m.chat, mentions: [m.sender], ptt: false, quoted: m }) => conn.sendMessage(option.id ? option.id : m.chat, { audio: aud, ptt: option.ptt ? option.ptt : false, mimetype: 'audio/mpeg', contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : ((option.quoted == null) ? null : m) })
	m.replyDoc = (doc, option = { id: m.chat, mentions: [m.sender], filename: 'undefined.pfd', mimetype: 'application/pdf', quoted: m }) => conn.sendMessage(option.id ? option.id : m.chat, { document: doc, mimetype: option.mimetype ? option.mimetype : 'application/pdf', fileName: option.filename ? option.filename : 'undefined.pdf', contextInfo: { mentionedJid: option.mentions ? option.mentions : [m.sender] } }, { quoted: option.quoted ? option.quoted : ((option.quoted == null) ? null : m) })
